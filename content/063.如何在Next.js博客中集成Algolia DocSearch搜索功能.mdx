...
DocSearch 的搜索和集成都非常方便，现在我的[博客模板](https://github.com/weijunext/weekly-boilerplate)、[博客](https://weijunext.com/)、[信息差周刊](https://gap.weijunext.com)都已经集成好了，这三个项目都是开源的，你可以直接复制我的组件代码。
