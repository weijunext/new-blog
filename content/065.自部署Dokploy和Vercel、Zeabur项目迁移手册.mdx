...
![hostinger](/assets/065/14.webp)

通常我们选择「带 `www` 前缀的域名指向不带 `www` 的域名地址」，也就是下拉框的第二个选项

![hostinger](/assets/065/15.webp)
